...
const Navigation = (props) => {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark bg-success myNav">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">
          <img src={logo1} height={50} width={50} alt='Eco Friendly Products'/>
          </Link>
          ...
          {!userSignIn.response && (
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div className="d-flex">
                <Link to="/signin" className="btn btn-success" type="button"><b>Login</b></Link>
              </div>
            </div>
          )}
        </div>
