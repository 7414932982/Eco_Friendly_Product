                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Tanisha Patil</strong><br/>
                                <label className="fs-7">Store Manager</label><br/>
                                <label className="fs-7">tanisha@grocers.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Aparna Sawant</strong><br/>
                                <label className="fs-7">Store Manager</label><br/>
                                <label className="fs-7">aparnas@grocers.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Aparna Sonawane</strong><br/>
                                <label className="fs-7">Store Manager</label><br/>
                                <label className="fs-7">aparna@grocers.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
