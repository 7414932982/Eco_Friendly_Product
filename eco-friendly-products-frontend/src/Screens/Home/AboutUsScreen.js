      ...
      <div className="info">
        <div className="row">
          ...
          <div className="col-md-12 col-sm-12 col-xs-12" Style="padding : 25px">
            ...
            <p>
            We’ve taken away all the stress associated with shopping for eco friendly products, and you can now order all your eco-friendly products online without travelling long distances or standing in serpentine queues. <br/>
            Add to this the convenience of finding all your requirements at one single source, along with great savings. <br/>
            Online eco-firendly product's shopping has never been easier.
            </p>
          </div>
